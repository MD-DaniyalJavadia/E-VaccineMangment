...
<div class="container-fluid py-2 d-none d-lg-flex">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white py-lg-0 px-lg-3">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav">
                        ...
                        <a href="{{route('services.page')}}" class="nav-item nav-link">Services</a>
                        ...
                        <a href="{{route('signup-parent')}}" class="nav-item nav-link">Sign Up</a>
                    </div>
    ...
    @yield("home-page-content")
    @yield("about-page-content")
    @yield("services-page-content")
    @yield("contact-page-content")
    @yield("features-page-content")
    @yield("team-page-content")
    @yield("testimonial-page-content")
    @yield("appoinment-page-content")
    @yield("notfound-page-content")
    <!-- Footer Start -->
