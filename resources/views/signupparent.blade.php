          ...
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <form class="mx-1 mx-md-4" method="post" action="{{route('signupparentpost')}}">
                  @csrf
                  ...
                  <label class="form-label" for="form3Example3c">Parent Email</label>
                  <div class="d-flex flex-row align-items-center mb-4">
                    <i class="fas fa-envelope fa-lg me-3 fa-fw"></i>
                    <div data-mdb-input-init class="form-outline flex-fill mb-0">
                      <input type="email" id="form3Example3c" name="parentEmail" class="form-control" />
                    </div>
                  </div>
                  ...
                  <label class="form-label" for="form3Example1c">Phno Number</label>
                  <div class="d-flex flex-row align-items-center mb-4">
                    <i class="fas fa-user fa-lg me-3 fa-fw"></i>
                    <div data-mdb-input-init class="form-outline flex-fill mb-0">
                     <!-- Example split danger button -->
                   <input type="text" id="form3Example1c" name="phnoNumber" class="form-control" />
                    </div>
                  </div>
